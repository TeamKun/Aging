...
public final class HiraganaConverter {
    ...
    private static HashMap<String, String> convertMap = new HashMap<>();

    static {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(getResource("convertTable.csv"), StandardCharsets.UTF_8))) {
            String line;
